            ...
            @foreach ($donasi as $d)
                <div class="col-md-4 mb-3">
                    <div class="card h-100 shadow-sm">
                        <img src="{{ asset('storage/' . $d->img1) }}" class="card-img-top"
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress mt-2 mb-1">
                                @php
                                    $persen =
                                        $d->target_donasi > 0
                                            ? min(100, ($d->perolehan_donasi / $d->target_donasi) * 100)
                                            : 100;
                                    $hariTersisa = Carbon::now()->diffInDays(Carbon::parse($d->masa_aktif), false);
                                @endphp
